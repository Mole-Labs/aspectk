...
class AroundMethodSignatureTargetingTest {
    @Test
    fun `MethodSignature should be created only for @Around target annotations`() {
        // given
        val result =
            compile(
                """
    ...
    @Test
    fun `MethodSignature should be created for multiple target annotations with @Around advice`() {
        // given
        val result =
            compile(
                """
                ...
                @Aspect
                object ExampleAspect {
                    @Around(TargetExample1::class, TargetExample2::class, TargetExample3::class)
                    fun doAround(pjp: ProceedingJoinPoint): Any? = pjp.proceed()
                }
    ...
    @Test
    fun `MethodSignature should be created only once when multiple target annotations exists with @Around advice`() {
        // given
        val result =
            compile(
                """
    ...
    @Test
    fun `MethodSignature should be created once for multiple @Around advices`() {
        // given
        val result =
            compile(
                """
    ...
    @Test
    fun `MethodSignatures should be created for many-to-many relationship between @Around advices and targets`() {
        // given
        val result =
            compile(
                """
            ...
            object ExampleAspect {
                ...
                @Around(TargetExample1::class, TargetExample3::class)
                fun doAround2(pjp: ProceedingJoinPoint): Any? = pjp.proceed()
