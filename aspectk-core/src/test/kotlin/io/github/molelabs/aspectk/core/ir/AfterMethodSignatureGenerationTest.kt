...
class AfterMethodSignatureGenerationTest {
    @Test
    ...
    @Test
    fun `MethodSignature contains annotations of method parameters with @After advice`() {
        // given
        val result =
            compile(
                """
    ...
    @Test
    fun `multiple MethodSignature can be created with @After advice`() {
        val result =
            compile(
                """
                import io.github.molelabs.aspectk.runtime.Aspect
    ...
    @Test
    fun `multiple MethodSignature can be created in multiple classes with @After advice`() {
        val result =
            compile(
                """
                import io.github.molelabs.aspectk.runtime.Aspect
