...
class AfterMethodSignaturePolymorphicTest {
    @Test
    fun `MethodSignature should not be created for implementations of annotated interface methods with @After advice`() {
        // given
        val result =
            compile(
                """
    ...
    @Test
    fun `MethodSignature should not be created for overriding methods with annotation on superclass with @After advice`() {
        // given
        val result =
            compile(
                """
    ...
    @Test
    fun `MethodSignature should be created only for overriding methods when annotated on child with @After advice`() {
        // given
        val result =
            compile(
                """
    ...
    @Test
    fun `MethodSignature should not be created for overriding methods with annotation on abstract class with @After advice`() {
        // given
        val result =
            compile(
                """
    ...
    @Test
    fun `MethodSignature should be created for default methods with annotation on interface with @After advice`() {
        val result =
            compile(
                """
            import io.github.molelabs.aspectk.runtime.Aspect
    ...
    @Test
    fun `MethodSignature should be created for default methods with annotation on abstract class with @After advice`() {
        val result =
            compile(
                """
            import io.github.molelabs.aspectk.runtime.Aspect
    ...
    @Test
    fun `MethodSignature should be created for both overridden methods and parent methods only when @After has inherits=true`() {
        val result =
            compile(
                """
            import io.github.molelabs.aspectk.runtime.Aspect
            ...
            @Aspect
            object ExampleAspect {
                @After(TargetExample1::class, TargetExample2::class, inherits = true)
                fun doAfter1(joinPoint: JoinPoint) {}

                @After(TargetExample1::class, inherits = true)
                fun doAfter2(joinPoint: JoinPoint) {}

                @After(TargetExample2::class, TargetExample3::class)
    ...
    @Test
    fun `MethodSignature should be created for methods from multiple interfaces when @After has inherits=true`() {
        // given
        val result =
            compile(
                """
