...
class PermissionAspectTest {
    ...
    @Test
    fun `PermissionAspect should allow function when required permission is granted`() {
    ...
    @Test
    fun `PermissionAspect should throw PermissionDeniedException when permission is missing`() {
    ...
    @Test
    fun `PermissionAspect should throw with descriptive message including permission name`() {
    ...
    @Test
    fun `PermissionAspect should throw with method name in message`() {
        val exception = assertFailsWith<PermissionDeniedException> {
            userService.getAllUsers()
        }
    ...
    @Test
    fun `PermissionAspect should allow ADMIN operations when ADMIN permission is granted`() {
    ...
    @Test
    fun `PermissionAspect should block ADMIN operations without ADMIN permission`() {
        assertFailsWith<PermissionDeniedException> {
    ...
    @Test
    fun `PermissionAspect should handle multiple permissions independently`() {
        // READ_USER_DATA만 부여
        PermissionAspect.grantedPermissions += "READ_USER_DATA"
    ...
    @Test
    fun `PermissionAspect should deny access after revoking permission`() {
        PermissionAspect.grantedPermissions += "READ_USER_DATA"
